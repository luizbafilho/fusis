...
var parseTests = []struct {
	...
	},
	{
		...
		toPrefixes([]string{"192.168.0.0/24", "192.168.0.2/32"}),
	},
	{
	...
	},
	{
		...
		toPrefixes([]string{"2001:db8::/64", "2001:db8::2/128"}),
	},
	{
	...
	// Mixed addresses, prefixes
	{
		...
		toPrefixes([]string{"172.16.0.0/16", "192.168.0.0/24", "192.168.0.3/32", "2001:db8::/64", "2001:db8::3/128"}),
	},
	{
